...
public class GoodsDaoImpl extends BaseDao implements GoodsDao {
	...
	public double getCount(String cityId, String catId) {
		...
		try {
			...
			if (org.apache.commons.lang.StringUtils.isNotBlank(cityId)) {
	...
	public List<Goods> getList(String cityId, String catId, int page, int size) {
		...
		Statement statement=null;
		ResultSet resultSet=null;
		String sql="select "+str+" from prodouct,shop where prodouct.shop_id=shop.shop_id"+(org.apache.commons.lang.StringUtils.isNotBlank(cityId)?("and city_id= "+cityId):"")+(org.apache.commons.lang.StringUtils.isNotBlank(catId)?("and category_id="+catId):"")+" limit "+(page*size)+","+size;
